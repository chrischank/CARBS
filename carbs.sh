...
dotfilesrepo="https://github.com/chrischank/dotfiles.git"
progsfile="https://github.com/chrischank/master/CARBS/progs.csv"
aurhelper="yay"
repobranch="master"
